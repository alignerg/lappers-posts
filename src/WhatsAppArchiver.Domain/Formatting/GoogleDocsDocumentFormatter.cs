...
/// </item>
/// <item>
/// <description>Plain text metadata section showing export date and total message count</description>
/// </item>
/// <item>
...
public sealed class GoogleDocsDocumentFormatter : IGoogleDocsFormatter, IMessageFormatter
{
    ...
    /// </item>
    /// <item>
    /// <description>Creates a title section with H1 header and plain text metadata</description>
    /// </item>
    /// <item>
    ...
    public GoogleDocsDocument FormatDocument(ChatExport chatExport)
    {
        ...
        // Add metadata sections (plain text, no bold)
        document.Add(new ParagraphSection($"Export Date: {chatExport.Metadata.ParsedAt.ToString("MMMM d, yyyy")}"));
        document.Add(new ParagraphSection($"Total Messages: {chatExport.MessageCount}"));
